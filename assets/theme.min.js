        ...
        }),
        {
          load: function (e, t) {
            ...
            if (o && o.status !== n.requested)
              if (((t = t || function () {}), o.status !== n.loaded)) {
                var a;
            ...
            if ((d || (d = a.dataset.controls), d)) {
              if (!l)
                document.querySelectorAll('[data-id="' + d + '"]').length > 0 &&
                  (l = a.parentNode.querySelector('[data-id="' + d + '"]'));
              if (l) {
                ...
                if (
                  ...
                  s(m, r ? m.offsetHeight - p : h + m.offsetHeight, !1, !1);
                if (window.SPR) {
                  var f = l.querySelector(".spr-summary-actions-newreview");
                  if (!f) return;
                  f.off("click" + i),
                    f.on("click" + i, function () {
                      (h = l.querySelector(e.moduleInner).offsetHeight),
                        s(l, h, r, u);
                    });
                }
              } else n = !1;
    ...
    if (
          ...
          (t.prototype = Object.assign({}, t.prototype, {
            init: function () {
              this.plus.addEventListener(
                "click",
                function () {
                  var maxcartValue = this.plus.getAttribute("data-max");
                  var e = this._getQty();
                  ...
                  if (e >= maxcartValue) {
                    var maximim_val = maxcartValue;
                    this._change(maximim_val);
                  }
                  else {
                    console.log('qty' + e + 1);
                    this._change(e + 1);
            ...
            enableVariantOption: function (t, i) {
              ...
              if ("dropdown" === this.type)
                ...
                s.classList.remove(e),
                  ...
                  i.soldOut && (s.classList.add(e), a.classList.add(e));
              }
            },
      ...
      (theme.videoModal = function () {
        var e,
          ...
          o = document.querySelectorAll(i.mp4Trigger);
          ...
          init: function () {
            ...
            (e = document.querySelector(o.wrapper)),
              ...
              a.stickyEnabled
                ? ((a.wrapperOverlayed = e.classList.contains(s.overlayStyle)),
                  ...
                  theme.config.stickyHeader
                    ? ((a.forceStopSticky = !1),
                      window.scrollY > a.threshold && d(),
                      window.on("scroll" + a.namespace, d))
                    : ((a.forceStopSticky = !0), c()))
                : c(),
            ...
            u &&
              ...
              (function () {
                ...
                theme.config.isTouch &&
                  document
                    .querySelectorAll(o.navLinksWithDropdown)
                    .forEach((e) => {
                      e.on("touchend" + a.namespace, function (e) {
                        e.currentTarget.parentNode.classList.contains(
                          ...
                          : (e.preventDefault(), d(), r(e.currentTarget));
                      });
                    });
                ...
                function r(t) {
                  var n = t.parentNode;
                  if (
                    (n.classList.contains(s.hasDropdownClass) &&
                      (n.classList.add(s.dropdownActive), (e = !0)),
                    ...
                    (i = !0),
                      document.documentElement.on(
                        ...
                        function () {
                          d(),
                            document.documentElement.off(o + a.namespace),
                            (i = !1);
                        }.bind(this)
                      );
                  }
                ...
                function c(e, i) {
                  var n = e.parentNode;
                  (n.classList.contains(s.hasSubDropdownClass) || i) &&
                    (n.classList.add(s.dropdownActive), (t = !0));
                }
                ...
                document.querySelectorAll(o.navLinks).forEach((e) => {
                  e.on("focusin" + a.namespace, n),
                    e.on("mouseover" + a.namespace, n),
            ...
            m.querySelectorAll(".grid-product") &&
              (new theme.QuickAdd(m), new theme.QuickShop(m)),
              window.on("load" + a.namespace, h),
              window.on("resize" + a.namespace, theme.utils.debounce(150, h));
          },
          removeOverlayClass: function () {
            a.wrapperOverlayed && e.classList.remove(s.overlayStyle);
          },
          disableOverlayHeader: function () {
            e.classList.remove(a.overlayEnabledClass, s.overlayStyle),
        ...
        function n(t) {
          (this.config = Object.assign({}, i, t)),
            ...
            this.container &&
              ...
              this.wrapper &&
                ((this.nav = this.wrapper.querySelector(e.nav)),
                (this.openTriggers = document.querySelectorAll(e.openBtn)),
                this.init()));
        }
        return (
          (n.prototype = Object.assign({}, n.prototype, {
      ...
      (theme.headerSearch = (function () {
        ...
        function c() {
          a.predictiveSearch &&
            (s.predictiveWrapper.classList.add("hide"),
            (s.results.innerHTML = ""),
            clearTimeout(e)),
            a.topSearched
              ? s.topSearched.classList.remove("hide")
        ...
        function d(t) {
          ...
          document.activeElement.blur(),
            ...
            a.predictiveSearch &&
              (s.predictiveWrapper.classList.add("hide"), clearTimeout(e)),
            s.inlineSearchContainer &&
              s.inlineSearchContainer.classList.remove("is-active"),
                            ...
                            fetch("/search/suggest.json?" + o)
                              ...
                              .then((e) => {
                                ...
                                var t = {},
                                  i = 0;
                                s.topSearched &&
                                  s.topSearched.classList.add("hide"),
                                  s.predictiveWrapper.classList.remove("hide");
        ...
        function p(e) {
          e.currentTarget.parentNode.classList.add("is-active"),
            a.topSearched && s.wrapper.classList.remove("hide"),
            f();
        }
        ...
        return {
          init: function () {
            if (
              ((s.inlineSearchContainer = document.querySelector(
                o.searchInlineContainer
              )),
              ...
              if (
                ((s.topSearched = document.querySelector(o.topSearched)),
                s.topSearched && (a.topSearched = !0),
                theme.settings.predictiveSearch)
              )
                if (document.getElementById("shopify-features"))
                  JSON.parse(
                    document.getElementById("shopify-features").innerHTML
                  ).predictiveSearch && (a.predictiveSearch = !0);
              a.predictiveSearch &&
                ((s.predictiveWrapper = document.querySelector(
                  o.predictiveWrapper
                )),
                ...
                document.querySelectorAll(o.form).forEach((e) => {
                  !(function (e) {
                    e.setAttribute("autocomplete", "off"),
                      e.on("submit" + a.namespace, u);
                    var t = e.querySelector(o.input);
                    t.on("focus" + a.namespace, p),
                      a.predictiveSearch && t.on("keyup" + a.namespace, m);
                  })(e);
                });
            }
          },
                ...
                setTimeout(function () {
                  ...
                  if (
                    ($(".cart_custom_item").each(function () {
                      var t = $(this).attr("data-metafield");
                      if ((console.log(t), "" != t)) {
                        var i = $(this).find(".upsell_products_cartfun").html();
                        return $(".custom_recom").html(i), (e = 1), !1;
                      }
                    }),
                    console.log(e),
                    0 == e)
                  ) {
                    var t = $(".defalt_upsell_product").html();
                    $(".custom_recom").html(t);
                  }
                }, 1e3),
      ...
      $(document).on("click", ".custom_recom .custom_quick_add", function (e) {
        var t = e.currentTarget,
          i = t.querySelector(".btn");
        i.classList.add("btn--loading");
        var n = {
            ...
            s.removeEventListener("mouseover", n),
              (function (i) {
                var n = document.querySelectorAll(
                  '.modal--quick-shop[data-product-id="' + i.id + '"]'
                );
                if (!n.length) return;
                if (e.indexOf(i.id) > -1)
                  !(function (e) {
      ...
      (theme.Maps = (function () {
        ...
        return (
          (window.gm_authFailure = function () {
            Shopify.designMode &&
              (document.querySelectorAll(o.section).forEach((e) => {
                  ...
                  if ("" !== n.trim()) {
                    (s.container.innerHTML = n),
                      ...
                      s.container.querySelector(e) &&
                        (s.drawer = new theme.Drawers(
                          "StoreAvailabilityDrawer",
                          "availability"
                        )),
                      s.container.querySelector(t) &&
                        (s.modal = new theme.Modals(
          ...
          (i.prototype = Object.assign({}, i.prototype, {
            ...
            open: function () {
              ...
              (s = window.pageYOffset || document.documentElement.scrollTop),
                document.querySelector(e.filterBar).getBoundingClientRect().top;
        ...
        return (
          (_.prototype = Object.assign({}, _.prototype, {
            init: function (e) {
              e || (this.container = document.getElementById(this.containerId)),
                ...
                this.colorImages.length &&
                  ((this.swatches = this.container.querySelectorAll(o)),
            ...
            fetchOpenCollasibleFilters: function () {
              return [
                ...Array.from(document.querySelectorAll(`${c} ${f}.${E}`)),
                ...Array.from(document.querySelectorAll(`${y} ${f}.${E}`)),
          ...
          (m.prototype = Object.assign({}, m.prototype, {
            ...
            toggleInventoryQuantity: function (e, t, i) {
              ...
              parseInt(i) <= parseInt(this.settings.inventoryThreshold)
                ...
                e && e.available
                  ? (n.parentNode.classList.remove(o),
                    s && s.classList.remove(o))
                  : (n.parentNode.classList.add(o), s && s.classList.add(o));
            },
    ...
    (theme.config.bpSmall = matchMedia(theme.config.mediaQuerySmall).matches),
      ...
      (a = function () {
        ...
        if (document.body.classList.contains("template-search")) {
          ...
          o &&
            o.querySelectorAll(".grid-product").length &&
            (new theme.QuickAdd(o), new theme.QuickShop(o));
        }
...
$(document).on("change", ".quantity_dropdown_product select", function (evt) {
  ...
  $("table.orichi-table.orichi-table-pricetype-1 tbody tr").each(function () {
    ...
    if (val_int >= min_data && val_int <= max_data) {
      ...
      var price_val_last = $(".orichi-table")
        .find("tr:last-child")
        .find("td:last-child")
        .text();
  ...
  var get_price = $(this)
    .parents(".product-single__meta")
    .find(".product__price_main")
    .text();
...
$(document).on("change", ".quantity_if_plus_custom", function (evt) {
  ...
  $(".product__quantity .js-qty__num").val(value);
  var get_price = parseInt(
    $(this)
      .parents(".grid-item__meta")
      .find(".grid-product__price--current")
      .attr("data-price")
  );
  var pn = get_price * value;
  //  $(this).parents('.grid-item__meta').find('.grid-product__price--current span').text(theme.Currency.formatMoney(pn, theme.settings.moneyFormat));
  ...
  $("table.orichi-table.orichi-table-pricetype-1 tbody tr").each(function () {
    ...
    if (val_int >= min_data && val_int <= max_data) {
      ...
      var price_val_last = $(".bss-b2b-qty-table-wrapper")
        .find("tr:last-child")
        .find("td:last-child")
        .text();
      $(".product__price_main").text(price_val_last);
...
$(document).on("change", ".quantity_dropdown select", function (evt) {
  ...
  if (nval.indexOf("+") > -1) {
    $(this)
      .parents(".grid-item.grid-product")
      .find(".styled-select select")
      .hide();
    $(this).parents(".grid-item.grid-product").find(".text_input_filed").show();
    $(this)
      .parents(".grid-item.grid-product")
      .find(".quantity_if_plus")
      .val(value);
  }

  $(this)
    .parents(".grid-item.grid-product")
    .find(".quick-add-btn.js-quick-add-btn_custom")
    .attr("data-qty", value);
  var get_price = parseInt(
    $(this)
      .parents(".grid-item__meta")
  ...
  $(this)
    ...
    .each(function () {
      ...
      if (val_int >= min_data && val_int <= max_data) {
        ...
        thnmain
          .parents(".grid-item__meta")
          .find(".grid-product__price--current span")
          .text(price_val);
        thnmain
          .parents(".grid-item__meta")
          .find(".onwords_text")
...
$(".submitbtnnss .order_sample_button").click(function () {
  ...
  $.ajax({
    ...
    success: function () {
     window.location.reload();
      // $(".site-nav__icons .cart-link").click();
    },
  });
});
